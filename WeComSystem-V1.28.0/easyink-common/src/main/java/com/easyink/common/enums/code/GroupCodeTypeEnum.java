...
public enum GroupCodeTypeEnum {
    ...
    public static void assertNotNull(Integer createType) {
        if (createType == null) {
            log.error("com.easyink.common.enums.code.GroupCodeTypeEnum.assertNotNull: createType is null");
        ...
        log.error("com.easyink.common.enums.code.GroupCodeTypeEnum.assertNotNull: createType is not exist");
        throw new CustomException(ResultTip.TIP_GENERAL_BAD_REQUEST);
    }
}
