...
@Slf4j
@Component
public class WeSuiteAccessTokenWebLoginInterceptor implements Interceptor<Object> {
    ...
    @Lazy
    public WeSuiteAccessTokenWebLoginInterceptor(WeAccessTokenService weAccessTokenService, RuoYiConfig ruoYiConfig) {
    ...
    public boolean beforeExecute(ForestRequest request) {
        ...
        String suiteId = ruoYiConfig.getProvider().getWebSuite().getSuiteId();
