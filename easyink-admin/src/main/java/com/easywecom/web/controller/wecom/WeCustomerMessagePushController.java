...
import com.easywecom.wecom.service.WeCustomerMessageOriginalService;
import com.easywecom.wecom.service.WeCustomerMessagePushService;
...
public class WeCustomerMessagePushController extends BaseController {
    ...
    public AjaxResult<CustomerMessagePushDTO> getMessageTask(@RequestParam(value = "messageId") Long messageId){
        return AjaxResult.success(weCustomerMessagePushService.getMessageInfo(messageId));
    }
