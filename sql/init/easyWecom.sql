...
VALUES (100, 0, '0', 'EasyWeCom', 0, 'EasyWeCom', '', '', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin',
        '2021-08-09 20:34:24');
INSERT INTO `sys_dept`
...
VALUES (1, 100, 'admin', 'admin', '00', NULL, NULL, '0', '',
        '$2a$10$9KjIyBKYZmD1fRt/VS8Rq.tgfTKt/jtX0Prr.vgxScIOuLk3y1X8S', '0', '0', '127.0.0.1', now(), 'admin', now(),
...
(
    ...
    `callback_uri`                 VARCHAR(255) CHARACTER SET utf8mb4
        COLLATE utf8mb4_general_ci                                                               NOT NULL DEFAULT ''
        COMMENT '应用回调url',
    PRIMARY KEY (`id`) USING BTREE
