package com.easywecom.web.core.config;
...
public class Knife4jConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.easywecom.web.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                .title("EasyWeCom企业微信SCRM系统")
                .description("EasyWeCom是一款开箱即用的企业微信SCRM系统，为企业提供私域流量营销系统的综合解决方案，帮助企业提高社交客户运营效率。")
