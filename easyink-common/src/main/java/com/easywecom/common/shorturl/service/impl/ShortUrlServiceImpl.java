package com.easywecom.common.shorturl.service.impl;
...
import com.easywecom.common.mapper.SysShortUrlMappingMapper;
import com.easywecom.common.shorturl.ShortUrlAppendInfo;
import com.easywecom.common.shorturl.SysShortUrlMapping;
import com.easywecom.common.shorturl.service.ShortUrlService;
import com.easywecom.common.utils.ConvertUrlUtil;
...
public class ShortUrlServiceImpl implements ShortUrlService {
    ...
    private final SysShortUrlMappingMapper sysShortUrlMappingMapper;
     ...
     */
    private final static String DUPLICATE_SUB = "*";
    /**
     * 缓存存储时间 单位分钟
     */
    private final static int REDIS_TIME_OUT = 2;

    public ShortUrlServiceImpl(SysShortUrlMappingMapper sysShortUrlMappingMapper, RedisCache redisCache) {
        this.sysShortUrlMappingMapper = sysShortUrlMappingMapper;
    ...
    public static void main(String[] args) {
        ...
        String test = "测试";
        String str = String.format("jkhaod1是的1dfag%s", test);
