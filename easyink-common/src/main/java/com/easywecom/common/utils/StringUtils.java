...
import com.easywecom.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static int weCustomTypeJudgment(String str) {
        if (isNotEmpty(str)) {
            ...
            if (str.startsWith("wb")) {
                return WeConstans.ID_TYPE_MACHINE;
            }
        }
        return WeConstans.ID_TYPE_USER;
    }
     ...
     * @param corpId 企业id
     */
    public static void checkCorpId(String corpId) {
