package com.easywecom.common.utils.bean;
...
public class BeanUtils extends org.springframework.beans.BeanUtils {
    ...
    public static void copyBeanProp(Object dest, Object src) {
        try {
            ...
            log.error("Bean属性复制异常 ex:【{}】", ExceptionUtils.getStackTrace(e));
        }
    }
        ...
        CacheFieldMap.getFieldMap(target.getClass()).values().forEach(it -> {
            ...
            if (field != null) {
                ...
                try {
                    ...
                    log.error("IllegalAccessException ex:【{}】",ExceptionUtils.getStackTrace(e));
                }
            }
        });
        return (T) target;
