...
import com.easywecom.wecom.client.WeAdminClient;
...
import com.easywecom.wecom.service.WeInitService;
...
public class WeAutoConfigServiceImpl implements WeAutoConfigService {
    ...
    public WeAdminQrcodeVO getAdminQrcode() {
        ...
        String qrcodeUrl = "https://work.weixin.qq.com/wwqrlogin/mng/qrcode/%s?login_type=login_admin";
