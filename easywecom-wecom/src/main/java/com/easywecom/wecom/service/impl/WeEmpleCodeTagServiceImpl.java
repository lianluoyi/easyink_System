...
import com.easywecom.wecom.mapper.WeEmpleCodeTagMapper;
 ...
 */
@Service
public class WeEmpleCodeTagServiceImpl extends ServiceImpl<WeEmpleCodeTagMapper, WeEmpleCodeTag> implements WeEmpleCodeTagService {
    @Autowired
