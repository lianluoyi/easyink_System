...
import com.easywecom.wecom.domain.vo.InsertWeMaterialVO;
import com.easywecom.wecom.domain.vo.WeMaterialCountVO;
import com.easywecom.wecom.domain.vo.WeMaterialFileVO;
...
import com.easywecom.wecom.service.WeMaterialTagRelService;
...
public class WeMaterialServiceImpl implements WeMaterialService {
    ...
    public WeMaterialFileVO uploadWeMaterialFile(MultipartFile file, String type) {
        ...
        try {
            //上传临时素材
            Optional<com.easywecom.common.enums.MediaType> mediaType = com.easywecom.common.enums.MediaType.of(type);
    ...
    public WeMaterialCountVO getMaterialCount(FindWeMaterialDTO findWeMaterialDTO) {
        //校验corpId
        com.easywecom.common.utils.StringUtils.checkCorpId(findWeMaterialDTO.getCorpId());
