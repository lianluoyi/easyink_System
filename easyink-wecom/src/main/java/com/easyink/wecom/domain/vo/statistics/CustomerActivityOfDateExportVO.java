...
public class CustomerActivityOfDateExportVO {
    ...
    @ApiModelProperty("时间")
    @Excel(name = "时间", sort = 1, dateFormat = "yyyy-MM-dd")
    ...
    public CustomerActivityOfDateExportVO(CustomerActivityOfDateVO customerActivityOfDate) {
        ...
        BeanUtils.copyProperties(customerActivityOfDate, this);
        customerAverageMessageCnt = customerActivityOfDate.getCustomerAverageMessageCnt();
        time = customerActivityOfDate.getTime();
    }
