...
public class WeCustomerExportVO extends WeCustomer {
    ...
    @Excel(name = "来源", sort = 3, readConverterExp = "0=未知来源,1=扫描二维码,2=搜索手机号,3=名片分享,4=群聊,5=手机通讯录,6=微信联系人,7=来自微信的添加好友申请,8=安装第三方应用时自动添加的客服人员,9=搜索邮箱,16=通过获客链接添加,201=内部成员共享,202=管理员负责人分配")
