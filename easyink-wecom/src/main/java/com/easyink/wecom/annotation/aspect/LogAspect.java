...
import com.easyink.common.enums.BusinessStatus;
import com.easyink.common.enums.HttpMethod;
...
public class LogAspect {
     ...
     * 对使用@Log注解的方法进行切面
     */
    @Pointcut("@annotation(com.easyink.common.annotation.Log)")
    ...
    private void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setCorpId(loginUser.getCorpId());
